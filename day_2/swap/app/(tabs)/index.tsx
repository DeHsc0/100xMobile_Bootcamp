...
export default function Swap () {
    ...
    const [fromAmmount , setFormAmmount ] = useState("0.000")
                ...
                <View className="border border-white">
                    <View className="absolute z-10 w-full h-full items-center justify-center">
                        <TouchableOpacity className="bg-black p-2 rounded-xl">
                            <Ionicons name="chevron-down" size={32} color={"#FFF"} ></Ionicons>
                        </TouchableOpacity>
                    </View>
                    <View className="flex gap-4">
                        <View className="flex gap-4 bg-[#1E1E1E] p-6 rounded-2xl">
                            <View className="flex-row gap-16" >
                                <Pressable className="bg-black rounded-2xl p-3">
                                ...
                                <TextInput className="text-white text-4xl font-medium" value={fromAmmount} onChangeText={setFormAmmount} keyboardType="number-pad" placeholder="0.000"/>
                            </View>
                            <View className="flex-row gap-16">
                                <Text className="text-[#A9AAB2] text-xl ">Balance: 0.0661 ETH</Text>
                                
                                <Text className=" text-[#A9AAB2] text-xl ">$499.749</Text>
